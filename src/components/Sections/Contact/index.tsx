  ...
  return (
    <Section className="bg-neutral-800" sectionId={SectionId.Contact}>
      <div className="flex flex-col items-center gap-y-6">
        ...
        <div className="flex flex-col items-center gap-y-6">
          <p className="prose text-center leading-6 text-neutral-300">{description}</p>
          <dl className="flex flex-col items-center space-y-4 text-base text-neutral-500 sm:space-y-2">
